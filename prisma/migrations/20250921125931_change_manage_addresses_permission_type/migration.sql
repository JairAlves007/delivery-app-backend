/*
  ...
  - The values [MANAGE_ADDRESSES] on the enum `PermissionType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."PermissionType_new" AS ENUM ('VIEW_CATALOG', 'ADD_TO_CART', 'MANAGE_OWN_ADDRESSES', 'VIEW_OWN_ORDERS', 'CANCEL_OWN_ORDER', 'MANAGE_PRODUCTS', 'MANAGE_CATEGORIES', 'MANAGE_PRODUCT_OPTIONS', 'MANAGE_DISTRICTS', 'MANAGE_ORDERS', 'MANAGE_OWN_ESTABLISHMENT', 'MANAGE_BANNERS', 'MANAGE_COUPONS', 'VIEW_CUSTOMERS', 'MANAGE_ESTABLISHMENTS', 'MANAGE_USERS');
