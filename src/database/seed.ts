...
const pizzariaBellaNapoli: EstablishmentSeed = {
  ...
  products: [
    ...
    },
    {
      ...
      description: "Queijo mussarela com goiabada cremosa e toque de canela.",
  ...
  addonCategories: [
    ...
    },
    {
      ...
      addons: [
        ...
        {
          name: "Gengibre em conserva (gari)",
          price: transformPriceToDatabase(3),
        },
...
async function seedEstablishment(
  ...
  establishmentOwnerRoleId: number,
) {
  ...
  const { makeCreateMenuForNewEstablishmentService } =
    await import("@/factories/services/menu/make-create-menu-for-new-establishment-service.js");
  const createMenuForEstablishmentService =
    makeCreateMenuForNewEstablishmentService();
