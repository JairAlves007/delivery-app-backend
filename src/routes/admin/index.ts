...
import { adminComboRoutes } from "./combo/index.js";
...
import { adminPromotionRoutes } from "./promotion/index.js";
import { adminRecommendationRoutes } from "./recommendation/index.js";
import { adminTagRoutes } from "./tag/index.js";
import { adminTagCombinationRoutes } from "./tag-combination/index.js";
...
export const adminRoutes = (app: FastifyInstance) => {
  app.register(
    async (api) => {
      ...
      api.register(adminPromotionRoutes, { prefix: "/promotion" });
      api.register(adminComboRoutes, { prefix: "/combo" });
      ...
      api.register(adminTagCombinationRoutes, { prefix: "/tag-combination" });
      api.register(adminRecommendationRoutes, { prefix: "/recommendation" });
